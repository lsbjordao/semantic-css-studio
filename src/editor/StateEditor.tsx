...
export function StateEditor() {
  ...
  const change = (property: string, value: string) =>
    value
      ? setProperty('states', key, property, value)
      : removeProperty('states', key, property)
    ...
    <div className="editor-panel">
      <div className="panel-heading">
        <div>
          ...
          <p>Style native pseudo-classes for interactive elements.</p>
        </div>
      </div>
      <div className="two-cols">
        ...
        <Field label="State">
          <select
            aria-label="State"
            value={state}
            onChange={(e) => setState(e.target.value as InteractionState)}
          >
            {states.map((item) => (
      ...
      <div className="field-grid">
        ...
        <TextField
          ...
          onChange={(value) => change('backgroundColor', value)}
        />
        <TextField
          label="Border color"
          value={styles.borderColor ?? ''}
          onChange={(value) => change('borderColor', value)}
        />
        <TextField
          label="Outline"
        ...
        <StepperField
          ...
          defaultUnit="px"
          step={1}
          onChange={(value) => change('outlineOffset', value)}
        />
        <TextField
          label="Transform"
          value={styles.transform ?? ''}
          onChange={(value) => change('transform', value)}
        />
        <StepperField
          label="Opacity"
        ...
        <SelectField
          ...
          onChange={(value) => change('cursor', value)}
        />
        <TextField
          label="Accent color"
